...
//        map.Marker('position', 'Position', _locationData.latitude,
//            _locationData.longitude)
//      ];
//      map.MapView mapView = map.MapView();
//      mapView.setMarkers(markers);
//      mapView.onMapReady.listen((_) {
//        mapView.setMarkers(markers);
//      });
//
//      var provider = map.StaticMapProvider(apiKey);
//      Uri uri =
//          await provider.getImageUriFromMap(mapView, width: 900, height: 400);
...
//    return formattedAddress;
    ...
    var coordinate = Coordinates(lat, lng);
    var addresses =
  ...
  void _getUserLocation() async {
    final location = new geolocation.Location();
    try {
...
//            content: Text('Pleade add an address manually'),
